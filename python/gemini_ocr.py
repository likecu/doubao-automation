...
class GeminiOCR:
    def __init__(self):
        ...
        self.rate_limits = {
            ...
            "gemini-2.5-flash-lite": {"rpm_limit": 5, "tpm_limit": 50000, "rpd_limit": 20},
            ...
            "gemini-1.0-pro": {"rpm_limit": 5, "tpm_limit": 10000, "rpd_limit": 10},
            "gemini-1.0-flash": {"rpm_limit": 5, "tpm_limit": 250000, "rpd_limit": 20},
            "gemini-pro-vision": {"rpm_limit": 5, "tpm_limit": 10000, "rpd_limit": 10},
        ...
        try:
            ...
            if show_details:
                ...
                rate_limits = [
                    ...
                    ("gemini-2.5-flash-lite", "轻量级模型", "3 / 5", "60 / 50K", "6 / 20"),
                    ...
                    ("gemini-1.0-pro", "基础模型", "2 / 5", "100 / 10K", "4 / 10"),
                    ("gemini-1.0-flash", "文本输出模型", "2 / 5", "268 / 250K", "6 / 20"),
                    ("gemini-pro-vision", "视觉模型", "2 / 5", "100 / 10K", "4 / 10"),
